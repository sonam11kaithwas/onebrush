...
import com.advantal.onebrush.databinding.ActivityInvoiceBinding;
...
/**
 * Created by Sonam on 25-04-2022 16:51.
 */
public class InvoiceActivity extends AppCompatActivity {
    private final boolean CHECKSTATE = false;
    private TextView tv_name, tv_date, tv_status;
...
//        setContentView(R.layout.activity_invoice);
        ...
        AppUtility.updateScreeState("InvoiceActivity", userAccountDetailsModel);
        createCounterTimer();
...
//        AppUtility.isDisplaySnacker(binding.layout, this,
//                msg);
...
//            MyDigitalClockForScreenLock.getInstance().stopTimerCounting();
    ...
    private void openDownloadDialog() {
        Dialog dialog = new Dialog(InvoiceActivity.this);
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(InvoiceActivity.this, CaseInformationActivity.class);
        startActivity(i);
