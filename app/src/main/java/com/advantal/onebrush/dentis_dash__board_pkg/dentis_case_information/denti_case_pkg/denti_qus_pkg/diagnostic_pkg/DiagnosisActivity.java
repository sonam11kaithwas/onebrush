...
import com.advantal.onebrush.databinding.ActivityDiagnosisBinding;
...
public class DiagnosisActivity extends AppCompatActivity {
    ...
    private TextView tv_name, tv_date, tv_status, tv_patient_regis, tv_patient_req, tv_patient_dentist;
...
//        setContentView(R.layout.activity_diagnosis);
        ...
        diagnosisViewModel = ViewModelProviders.of(this).get(DiagnosisViewModel.class);
        ...
        AppUtility.updateScreeState("DiagnosisActivity", userAccountDetailsModel);

        createCounterTimer();


        tv_name = findViewById(R.id.tv_patient_name);
        tv_patient_regis = findViewById(R.id.tv_patient_regis);
        tv_date = findViewById(R.id.tv_patient_dentist);
        tv_status = findViewById(R.id.tv_patient_status);
        tv_patient_req = findViewById(R.id.tv_patient_req);
        tv_patient_dentist = findViewById(R.id.tv_patient_dentist);
    ...
    private void openDownloadDialog() {
        ...
        Dialog dialog = new Dialog(DiagnosisActivity.this);
    ...
    public void onBackPressed() {
        if (binding.layoutForView.getVisibility() == View.GONE)
            ...
            Intent i = new Intent(DiagnosisActivity.this, CaseInformationActivity.class);
            startActivity(i);
