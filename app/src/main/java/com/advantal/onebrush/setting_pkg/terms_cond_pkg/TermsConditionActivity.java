package com.advantal.onebrush.setting_pkg.terms_cond_pkg;
...
import com.advantal.onebrush.databinding.ActivityTermsConditionBinding;
...
public class TermsConditionActivity extends AppCompatActivity {
    ...
    private Terms_Con_View_Model termsConViewModel;
...
//        pdfView1 = findViewById(R.id.terms_pdf);
        termsConViewModel = ViewModelProviders.of(this).get(Terms_Con_View_Model.class);
...
//        pdfView1 = findViewById(R.id.terms_pdf);
        ...
        AppUtility.updateScreeState("TermsConditionActivity", userAccountDetailsModel);
        createCounterTimer();


        binding.termsPdf.fromAsset("onebrush_tnc.pdf")
                .defaultPage(0)
...
*/
        // web.loadUrl("file:///asset/onebrush_tnc.pdf");
...
/*
    private void loadTermsCond() {
        if (AppUtility.isNetworkConnected())
            web.loadUrl("https://docs.google.com/gview?embedded=true&url=" + "http://36.255.3.15/Onebrush/onebrush_tnc.pdf");
        else {
    ...
    public void onClickCondition(View view) {
        switch (view.getId()) {
            ...
            case R.id.back_button:
                Intent intent = new Intent(TermsConditionActivity.this, SettingsActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
